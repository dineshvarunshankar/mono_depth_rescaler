...
bool PoseBuffer::lookup(
    int64_t t_ns, int64_t feature_tol_ns, ext_vio_data_t* pkt_out,
...
bool PoseBuffer::get_pose(
    ...
    float T_out[3], float R_out[3][3]) const {
    return lookup(t_ns, feature_tol_ns, nullptr, T_out, R_out);
}

bool PoseBuffer::get(int64_t t_ns, int64_t feature_tol_ns,
                     ext_vio_data_t& pkt_out,
                     float T_out[3], float R_out[3][3]) const {
    return lookup(t_ns, feature_tol_ns, &pkt_out, T_out, R_out);
}
